  ...
  async send(notification) {
    try {
      ...
      if (isMulticast) {
        ...
        // We use 'background' rather than 'liveactivity' so the Flutter background isolate is correctly awoken.
        const apnsPushType = isSilent ? "background" : "alert";
        const apnsPriority = isSilent ? "5" : "10";
