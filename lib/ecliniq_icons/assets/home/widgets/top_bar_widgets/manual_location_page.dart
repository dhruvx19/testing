...
class _ManualLocationPageState extends State<ManualLocationPage> {
  ...
  final List<String> _otherCities = [
    'Agra', 'Ajmer', 'Akola', 'Aligarh', 'Allahabad', 'Alwar', 'Amravati', 'Amritsar', 
    'Anantapur', 'Asansol', 'Aurangabad', 'Bareilly', 'Belgaum', 'Bellary', 'Berhampur', 
    'Bhagalpur', 'Bhavnagar', 'Bhilai', 'Bhilwara', 'Bhopal', 'Bhubaneswar', 'Bhiwandi', 
    'Bikaner', 'Bilaspur', 'Bokaro Steel City', 'Brahmapur', 'Chandigarh', 'Chandrapur', 
    'Coimbatore', 'Cuttack', 'Darbhanga', 'Davanagere', 'Dehradun', 'Dhanbad', 'Dhule', 
    'Durgapur', 'Erode', 'Faridabad', 'Firozabad', 'Gaya', 'Ghaziabad', 'Goa', 'Gopalpur', 
    'Gorakhpur', 'Gulbarga', 'Guntur', 'Gurgaon', 'Guwahati', 'Gwalior', 'Haldia', 'Haridwar', 
    'Hazaribagh', 'Hosur', 'Hubli-Dharwad', 'Indore', 'Jabalpur', 'Jalandhar', 'Jalgaon', 
    'Jalna', 'Jammu', 'Jamnagar', 'Jamshedpur', 'Jhansi', 'Jodhpur', 'Junagadh', 'Kakinada', 
    'Kalyan-Dombivli', 'Kanchipuram', 'Kannur', 'Kanpur', 'Karnal', 'Karur', 'Kharagpur', 
    'Kochi', 'Kolhapur', 'Kollam', 'Korba', 'Kota', 'Kottayam', 'Kozhikode', 'Kullu', 
    'Kurnool', 'Latur', 'Lucknow', 'Ludhiana', 'Madurai', 'Malappuram', 'Malegaon', 
    'Mangalore', 'Mathura', 'Meerut', 'Mirzapur', 'Moradabad', 'Muzaffarnagar', 'Muzaffarpur', 
    'Mysore', 'Nadiad', 'Nagercoil', 'Nagpur', 'Nanded', 'Nashik', 'Nellore', 'Nizamabad', 
    'Noida', 'Palakkad', 'Panchkula', 'Panipat', 'Panaji', 'Parbhani', 'Patiala', 'Patna', 
    'Pondicherry', 'Prayagraj', 'Puri', 'Purnia', 'Raichur', 'Raipur', 'Rajahmundry', 
    'Rajkot', 'Rampur', 'Ranchi', 'Ratlam', 'Rewa', 'Rohtak', 'Rourkela', 'Sagar', 'Saharanpur', 
    'Salem', 'Sangli', 'Satara', 'Satna', 'Secunderabad', 'Shimla', 'Shimoga', 'Sikar', 
    'Siliguri', 'Solapur', 'Sonipat', 'Srinagar', 'Thane', 'Thanjavur', 'Thiruvananthapuram', 
    'Thoothukudi', 'Thrissur', 'Tiruchirappalli', 'Tirunelveli', 'Tirupati', 'Tiruppur', 
    'Tumkur', 'Udaipur', 'Ujjain', 'Ulhasnagar', 'Vadodara', 'Varanasi', 'Vasai-Virar', 
